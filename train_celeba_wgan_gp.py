...
import utils
#turn on gp(gradient penality) with GP = True
GP = False
...
imagenet_data = dsets.ImageFolder('/data/lisa/data/img_align_celeba/', transform=transform)
...
""" load checkpoint """
ckpt_dir = '/data/lisa/data/sai/celeba_wgan_gp/checkpoints/celeba_wgan_gp'
...
for epoch in range(start_epoch, epochs):
    for i, (imgs, _) in enumerate(data_loader):
        ...
        if (i + 1) % 100 == 0:
            ...
            save_dir = '/data/lisa/data/sai/sample_images_while_training/celeba_wgan_gp'
